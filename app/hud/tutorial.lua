...
function Tutorial:next()
	if self.state ~= 'Done' then if love.keyboard.isDown('rshift') then self.state = 'Done' else self.state = self.nextState end end
end
